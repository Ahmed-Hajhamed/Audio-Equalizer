...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.controls_layout.addWidget(self.original_media_player)
        self.controls_layout.addWidget(self.equlized_media_player)
        ...
        self.frequency_domain_layout.addWidget(self.line_3, 0, 0, 1, 2)
